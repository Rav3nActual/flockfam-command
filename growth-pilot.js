...
const PILOT_STAGES=[
  ...
  },
  {
    ...
    actions:[
      ...
      "<strong>Pass the Supplier Readiness Gate.</strong> Before paying a deposit, record the approved sample, written quote, landed cost, MOQ and size curve, production and reorder lead times, defect/replacement terms, ownership of artwork/tech packs/tooling, and the backup plan if the supplier misses. Core inventory cannot depend on a mystery timeline or files FlockFam does not control.",
    ...
    deliverables:["2 core tees, 1 hat, 3–4 patches available","Supplier Readiness sheet for every ordered SKU","Complete mobile product pages","One tested bundle or offer","Email and back-in-stock capture","Blank proof log","Successful test order and verified tracking"],
  ...
  },
  {
    ...
    actions:[
      ...
      "<strong>Give each kind of sample one job.</strong> Creator apparel samples aim to produce product experience, content, or a relationship. Low-cost patch/sticker samples at a field session aim to create a first purchase or signup. Order inserts aim to create a repeat purchase, referral, or customer post. Do not mix the cohorts and then pretend the program worked.",
      "<strong>Calculate sampling economics before giving inventory away.</strong> Cost per sampled person equals landed sample cost plus packaging and distribution. First-order break-even conversion equals cost per sampled person divided by expected CM2 from the follow-on order. Track the sample cohort for 30 and 60 days; another brand's one-in-ten result is not a FlockFam assumption.",
      "<strong>Use the cheapest sample that can do the job.</strong> Do not mail apparel to random consumers. Use patches or stickers for small consumer tests, and reserve apparel for qualified creators or real product testers. Every sample must fit inside the existing Stage 02 budget.",
    ...
    deliverables:["50-person prospect list with coverage tags","Working creator pipeline with every status current","About 30 outreach messages plus documented follow-ups","15–20 product-only creator seeds","Separate log for creator, field, and order-insert samples","Sampling cost and break-even conversion calculated","6 paid creator agreements","Deal math and rights recorded for every paid relationship","At least 12 guaranteed usable videos","Target of 20–30 total usable clips plus photos"],
  ...
  },
  {
    ...
    actions:[
      ...
      "<strong>Label every asset by its primary job.</strong> PERFORMANCE asks for a measurable action. BRAND builds memory, meaning, or trust. BOTH must still have one primary success metric. The pilot does not need a separate brand-ad budget to make reusable brand assets.",
      "<strong>Run the Non-Obvious + True filter.</strong> Ask: Is the idea rooted in a provable FlockFam truth? Is it more distinctive than a standard outdoor cliché? Does it support a pilot priority? Can people understand it? Preserve the raven, orange, Get Outdoors, and other brand codes even when the campaign idea changes.",
      "<strong>Allow one controlled brand experiment.</strong> Use existing content or production resources for one unusual but truthful execution. It must not require a new budget, and it still needs a stated signal such as qualified attention, searches, signups, or customer response.",
    ...
    deliverables:["2–3 weeks of consistent organic testing","Organic and commerce posts labeled separately","Every asset tagged Performance, Brand, or Both","One controlled Non-Obvious + True experiment","Results logged by creative and hook","At least two founder-forward proof posts","Three strongest creative concepts identified","Customer questions added to product pages or new content"],
  ...
  },
  {
    ...
    actions:[
      ...
      "<strong>Keep this pilot evidence-first.</strong> Another company's 90/10 performance-to-brand launch split is not a FlockFam budget formula. Paid media remains tied to acquisition proof; organic creator, founder, and community content builds brand equity without creating a separate brand-media spend line.",
...
const PILOT_TERMS=[
  ...
  ["Sampling","Giving product to a defined group so they can experience it before being asked to buy or act. Creator seeding, consumer field samples, and customer order inserts are different sampling cohorts with different goals."],
  ["Sample break-even conversion","Cost per sampled person divided by CM2 on the expected follow-on order. If one sample costs $3 and a later order contributes $24 of CM2, at least 12.5% must convert for first-order contribution to repay the samples."],
  ["Performance marketing","Marketing primarily expected to produce a measurable action such as a click, signup, add-to-cart, or purchase within a useful time window."],
  ["Brand marketing","Marketing primarily intended to build memory, meaning, trust, and future demand. It can still be measured, but the result may be delayed or spread across channels."],
  ["Non-Obvious + True","A creative filter requiring an idea to be both distinctive and grounded in a provable product, founder, customer, or brand truth. Weirdness without truth is just a stunt."],
  ["Single-source risk","Depending on one supplier, factory, material, pattern, formula, or file owner with no workable backup. A missed shipment or lost file can then stop the entire product."],
...
function viewGrowthPilot(){
  ...
  return `<section class="growth-pilot"><div class="page-head"><div><h1>$10K Growth Pilot</h1><p>A 90–120 day test to prove FlockFam can turn new people into profitable customers.</p></div><div class="pilot-head-actions"><button class="btn ghost sm" data-pilot-collapse>Close all</button><button class="btn sm" data-pilot-expand>Open all</button></div></div>
    ...
    <div class="panel"><div class="panel-head"><h2>Three Preflight Checks <span class="count">before product leaves or money moves</span></h2></div><div class="pilot-score-wrap"><table class="pilot-score"><thead><tr><th>Decision</th><th>Questions to answer first</th><th>Pilot rule</th></tr></thead><tbody>
      <tr><td>Give away a sample</td><td>Who receives it? What exact behavior should follow? What does each sampled person cost? What conversion repays that cost from CM2?</td><td>Track creator, field, and order-insert cohorts separately. No unattributed mass giveaway.</td></tr><tr><td>Approve a creative idea</td><td>Is it provably true, distinct from outdoor clichés, understandable, useful to a pilot priority, and recognizably FlockFam?</td><td>Change the campaign idea—not the core brand codes. One unproven brand experiment maximum.</td></tr><tr><td>Pay a supplier</td><td>Is the sample approved? Are landed cost, MOQ, lead/reorder time, defects, file ownership, and backup plan written down?</td><td>No inventory deposit until the Supplier Readiness Gate is complete.</td></tr>
    </tbody></table></div><div class="pilot-example"><strong>Sampling example:</strong> If a patch/sticker sample costs $3 per person after packaging and distribution, and the expected follow-on order creates $24 of CM2, the first-order break-even conversion is $3 ÷ $24 = 12.5%. That is the FlockFam threshold to test—not another brand's “one in ten” story.</div></div>
